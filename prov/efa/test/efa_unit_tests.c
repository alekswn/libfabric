...
int main(void)
{
	...
	const struct CMUnitTest efa_unit_tests[] = {
		...
		cmocka_unit_test(test_efa_platform_feature_name),
		cmocka_unit_test(test_efa_platform_feature_none),
		cmocka_unit_test(test_efa_platform_feature_force),
		cmocka_unit_test(test_efa_platform_feature_disable_wins),
		cmocka_unit_test(test_efa_platform_feature_unknown_token),
		cmocka_unit_test(test_efa_platform_feature_list_parse),
		cmocka_unit_test(test_efa_platform_feature_wide_wqe_force),
		cmocka_unit_test(test_efa_platform_feature_wide_wqe_disable),
		cmocka_unit_test(test_efa_platform_feature_independent_bits),
